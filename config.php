...
if (!defined("NOME_DATABASE"))
    define("NOME_DATABASE", "earthquake-monitor");
...
if (!defined("PREFISSO_TAVOLA"))
    define("PREFISSO_TAVOLA", "em");

if (!defined("NOME_APPLICAZIONE"))
    define("NOME_APPLICAZIONE", "Earthquake Monitor");
...
//VARIABILI PER IL SERVIZIO HERE GEOCODE
if (!defined("BASE_URL_HERE"))
    define("BASE_URL_HERE", "https://geocode.search.hereapi.com/v1/geocode?countryCode=ITA");
if (!defined("API_KEY_HERE"))
    define("API_KEY_HERE", "");
